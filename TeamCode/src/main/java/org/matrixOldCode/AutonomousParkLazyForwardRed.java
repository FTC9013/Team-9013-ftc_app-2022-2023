...
import java.util.Queue;
    ...
    @Autonomous(name = "AutonomousParkLazyForwardRed", group = "Linear Opmode")

//@Disabled
    public class AutonomousParkLazyForwardRed extends LinearOpMode
    {
      ...
      public void runOpMode() {
        ...
        MoveToParkSpot.add(new Leg(Leg.Mode.RIGHT, 100, 0, 1.2));
